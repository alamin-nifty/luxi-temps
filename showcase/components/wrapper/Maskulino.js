...
import appTheme from '../../theme/maskulinoMui';
...
const useStyles = makeStyles({ uniqId: 'maskulino' })(theme => ({
  spaceTopShort: {
...
function Maskulino(props) {
  ...
  const [color, changeColor] = useState('maskulino');
  const [themeMode, changeMode] = useState('dark');
  const [theme, setTheme] = useState({
    direction: 'ltr',
    ...appTheme('maskulino', 'dark'),
  });
