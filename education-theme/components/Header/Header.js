            ...
            <nav className={cx(classes.navMenu, classes.navAuth)}>
              {!isMobile && (
                <Fragment>
                  ...
                  <Button className={classes.textBtn} href={curLang + routeLink.education.login}>
                    {t('education-landing.header_login')}
                  </Button>
                  <Button className={classes.btnWhite} href={curLang + routeLink.education.register} variant="contained">
